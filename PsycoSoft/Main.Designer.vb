...
Partial Class Main
    ...
    Private Sub InitializeComponent()
        ...
        Me.browseProfileBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.eraseProfileBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.BarSubItem1 = New DevExpress.XtraBars.BarSubItem()
        Me.mbtiBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.MI_BarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.belbinBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.bigFiveBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.EneagramBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.FiroBBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        Me.sdsBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        ...
        Me.discBarButtonItem = New DevExpress.XtraBars.BarButtonItem()
        ...
        '
        'browseProfileBarButtonItem
        '
        Me.browseProfileBarButtonItem.Caption = "Browse Profile"
        Me.browseProfileBarButtonItem.Id = 62
        Me.browseProfileBarButtonItem.LargeImageIndex = 3
        Me.browseProfileBarButtonItem.Name = "browseProfileBarButtonItem"
        '
        'eraseProfileBarButtonItem
        '
        Me.eraseProfileBarButtonItem.Caption = "Erase Profile"
        Me.eraseProfileBarButtonItem.Id = 63
        Me.eraseProfileBarButtonItem.LargeImageIndex = 9
        Me.eraseProfileBarButtonItem.Name = "eraseProfileBarButtonItem"
        '
        'BarSubItem1
        '
        Me.BarSubItem1.Caption = "Select MODULE"
        Me.BarSubItem1.Id = 64
        Me.BarSubItem1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.mbtiBarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.MI_BarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.belbinBarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.bigFiveBarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.EneagramBarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.FiroBBarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.sdsBarButtonItem), New DevExpress.XtraBars.LinkPersistInfo(Me.discBarButtonItem)})
        Me.BarSubItem1.Name = "BarSubItem1"
        '
        'mbtiBarButtonItem
        '
        Me.mbtiBarButtonItem.Caption = "MBTI"
        Me.mbtiBarButtonItem.Id = 65
        Me.mbtiBarButtonItem.Name = "mbtiBarButtonItem"
        '
        'MI_BarButtonItem
        '
        Me.MI_BarButtonItem.Caption = "Multiple Inteligence"
        Me.MI_BarButtonItem.Id = 66
        Me.MI_BarButtonItem.Name = "MI_BarButtonItem"
        '
        'belbinBarButtonItem
        '
        Me.belbinBarButtonItem.Caption = "Belbin"
        Me.belbinBarButtonItem.Id = 67
        Me.belbinBarButtonItem.Name = "belbinBarButtonItem"
        '
        'bigFiveBarButtonItem
        '
        Me.bigFiveBarButtonItem.Caption = "Big Five"
        Me.bigFiveBarButtonItem.Id = 68
        Me.bigFiveBarButtonItem.Name = "bigFiveBarButtonItem"
        '
        'EneagramBarButtonItem
        '
        Me.EneagramBarButtonItem.Caption = "Eneagram"
        Me.EneagramBarButtonItem.Id = 69
        Me.EneagramBarButtonItem.Name = "EneagramBarButtonItem"
        '
        'FiroBBarButtonItem
        '
        Me.FiroBBarButtonItem.Caption = "Firo-B"
        Me.FiroBBarButtonItem.Id = 70
        Me.FiroBBarButtonItem.Name = "FiroBBarButtonItem"
        '
        'sdsBarButtonItem
        '
        Me.sdsBarButtonItem.Caption = "SDS"
        Me.sdsBarButtonItem.Id = 71
        Me.sdsBarButtonItem.Name = "sdsBarButtonItem"
        '
        ...
        Me.ribbonImageCollectionLarge.Images.SetKeyName(9, "Action_Clear_32x32.png")
        '
        'homeRibbonPage
        '
        Me.homeRibbonPage.Groups.AddRange(New DevExpress.XtraBars.Ribbon.RibbonPageGroup() {Me.RibbonPageGroup1, Me.RibbonPageGroup2})
        Me.homeRibbonPage.Name = "homeRibbonPage"
        Me.homeRibbonPage.Text = "Home"
        '
        'RibbonPageGroup1
        '
        Me.RibbonPageGroup1.ItemLinks.Add(Me.browseProfileBarButtonItem)
        Me.RibbonPageGroup1.ItemLinks.Add(Me.eraseProfileBarButtonItem)
        ...
        Me.RibbonPageGroup2.Text = "Module"
        '
        'helpRibbonPage
        '
        ...
        'discBarButtonItem
        '
        Me.discBarButtonItem.Caption = "DISC"
        Me.discBarButtonItem.Id = 72
        Me.discBarButtonItem.Name = "discBarButtonItem"
        '
        'Main
        '
    ...
    Friend WithEvents browseProfileBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents eraseProfileBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents BarSubItem1 As DevExpress.XtraBars.BarSubItem
    Friend WithEvents mbtiBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents RibbonPageGroup1 As DevExpress.XtraBars.Ribbon.RibbonPageGroup
    Friend WithEvents RibbonPageGroup2 As DevExpress.XtraBars.Ribbon.RibbonPageGroup
    Friend WithEvents MI_BarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents belbinBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents bigFiveBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents EneagramBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents FiroBBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents sdsBarButtonItem As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents discBarButtonItem As DevExpress.XtraBars.BarButtonItem
